...
const initSmoothScrolling = ()=>{
    ...
    (0, _scrollTrigger.ScrollTrigger).scrollerProxy(".content", {
        scrollTop (value) {
...
function changeWords() {
    let webDevelopment = serviceTag[Math.floor(Math.random() * serviceTag.length)];
    let webDevelopment2 = serviceTag[Math.floor(Math.random() * serviceTag.length)];
    document.querySelector(".selected-works-list__link-desc").innerHTML = webDevelopment;
    document.querySelectorAll(".selected-works-list__link-desc")[1].innerHTML = webDevelopment2;
}
function changeWordsCustomPlugin() {
    let customPlugin = pluginDevelopmentTags[Math.floor(Math.random() * pluginDevelopmentTags.length)];
    let customPlugin2 = pluginDevelopmentTags[Math.floor(Math.random() * pluginDevelopmentTags.length)];
    document.querySelectorAll(".selected-works-list__link-desc")[2].innerHTML = customPlugin;
    document.querySelectorAll(".selected-works-list__link-desc")[3].innerHTML = customPlugin2;
}
function changeWordsWordpressMaintainance() {
    let wMaintainance = wordpressMaintainance[Math.floor(Math.random() * wordpressMaintainance.length)];
    let wMaintainance2 = wordpressMaintainance[Math.floor(Math.random() * wordpressMaintainance.length)];
    document.querySelectorAll(".selected-works-list__link-desc")[4].innerHTML = wMaintainance;
    document.querySelectorAll(".selected-works-list__link-desc")[5].innerHTML = wMaintainance2;
}
function changeWordsEcomDevelopment() {
    let ecommerceDev = ecomDevelopment[Math.floor(Math.random() * ecomDevelopment.length)];
    let ecommerceDev2 = ecomDevelopment[Math.floor(Math.random() * ecomDevelopment.length)];
    document.querySelectorAll(".selected-works-list__link-desc")[6].innerHTML = ecommerceDev;
    document.querySelectorAll(".selected-works-list__link-desc")[7].innerHTML = ecommerceDev2;
}
...
$(document).ready(function() {
    ...
    $(".selected-works-list__link-wrap").hover(function() {
        var $this = $(this); // Get current hovered element
        // Clear any existing timeouts
        clearTimeout(timeoutId);
        clearTimeout(timeoutId2);
        var counter = 3; // set counter to 5
        $this.find(".selected-works-list__link-progress-counter").text(`0${counter}`);
        ...
        timeoutId = setTimeout(function() {
            ...
            $this.next(".work-content-description").addClass("work-content-description-active");
        }, 3000); // 5 seconds
    }, function() {
        ...
        timeoutId2 = setTimeout(function() {
            ...
            $(".work-content-description").removeClass("work-content-description-active");
        }, 2000); // 2 seconds
    });
});

},{"@studio-freight/lenis":"ggVJc","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"77jB6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ggVJc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["gIPAz","83FZ8"], "83FZ8", "parcelRequire7c9a")
